RSpec.describe "admin", type: :request do
  describe "GET" do
    context "get_requirement_facilities" do
      context "responce" do
        ...
        it "get_requirement_facilities responce is 200 with exist data" do
          get dokotomeyo_admin_requirementFacility_path, params: {
            select: 1,
            input: existing_requirement_facility.id
          }
          expect(JSON.parse(response.body)["status"]).to eq 200
        end

        it "get_requirement_facilities responce is 400 with not exist data" do
          get dokotomeyo_admin_requirementFacility_path, params: {
            select: 1,
            input: 9
          }
      ...
      context "filtering" do
        ...
        it "filtering id" do
          ...
          expect(JSON.parse(response.body)["requirements"]).not_to include(requirement_2.attributes, requirement_3.attributes, requirement_4.attributes, requirement_5.attributes)
        end
