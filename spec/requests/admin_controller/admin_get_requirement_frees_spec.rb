RSpec.describe "admin", type: :request do
  describe "GET" do
    context "get_requirement_frees" do
      context "responce" do
        ...
        it "get_requirement_frees responce is 200 with exist data" do
          get dokotomeyo_admin_requirementFree_path, params: {
            select: 1,
            input: existing_requirement_free.id
          }
          expect(JSON.parse(response.body)["status"]).to eq 200
        end

        it "get_requirement_frees responce is 400 with not exist data" do
          get dokotomeyo_admin_requirementFree_path, params: {
            select: 1,
            input: 9
          }
