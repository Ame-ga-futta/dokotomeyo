RSpec.describe "Parkings", type: :request do
  describe "POST" do
    ...
    context "add_confirm" do
      context "add RequirementBuy" do
        it "add_confirm responce is 200 with fulldata" do
        ...
        it "add_confirm responce is 400 without RequirementBuy data" do
          post dokotomeyo_add_confirm_path, params: {
            add_requirement: {
              requirement_type: "buy",
              parkingID: parking.id,
      ...
      context "add RequirementFacility" do
        ...
        it "add_confirm responce is 400 without RequirementFacility data" do
          post dokotomeyo_add_confirm_path, params: {
            add_requirement: {
              requirement_type: "facility",
              parkingID: parking.id,
      ...
      context "add RequirementFree" do
        ...
        it "add_confirm responce is 400 without RequirementFree data" do
          post dokotomeyo_add_confirm_path, params: {
            add_requirement: {
              requirement_type: "free",
              parkingID: parking.id,
        ...
        context "additional_limit" do
          ...
          it "add_confirm responce is 400 when add second RequirementFree data" do
            post dokotomeyo_add_confirm_path, params: {
              add_requirement: {
                requirement_type: "free",
                parkingID: parking.id,
      ...
      context "add RequirementTime" do
        ...
        it "add_confirm responce is 400 without RequirementTime data" do
          post dokotomeyo_add_confirm_path, params: {
            add_requirement: {
              requirement_type: "time",
              parkingID: parking.id,
